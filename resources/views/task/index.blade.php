    ...
    <table class="table table-striped">
        ...
        @foreach ($tasks as $task)
            <tr>
                ...
                <td>
                    <a href="{{route('projects.tasks.show', [$task->project->id, $task->id])}}">{{ $task->name }}</a>
                </td>
                <td>
                    {{ $task->priority }}
                </td>
                ...
                <td>
                    <a class="btn btn-success"
                       href="{{ route('projects.tasks.edit', [$task->project->id, $task->id]) }}">편집</a>
                </td>
                <td>
                    <form method="POST" action="{{ route('projects.tasks.destroy', [$task->project->id, $task->id]) }}">
                        {{ csrf_field() }}
                        {{ method_field('DELETE') }}
